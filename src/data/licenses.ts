 ...
 * (hiệu lực từ 01/01/2025). Cấu trúc đề thi lý thuyết tham khảo theo quy định
 * hiện hành về sát hạch; có thể chỉnh trong `exam` nếu quy định thay đổi.
 */
export const LICENSES: License[] = [
  {
    id: "A1", name: "Hạng A1", short: "Mô tô đến 125 cm³",
  ...
  {
    id: "A", name: "Hạng A", short: "Mô tô trên 125 cm³",
  ...
  {
    id: "B1", name: "Hạng B1", short: "Mô tô ba bánh",
  ...
  {
    id: "B", name: "Hạng B", short: "Ô tô đến 8 chỗ, tải ≤ 3,5 tấn",
  ...
  {
    id: "C1", name: "Hạng C1", short: "Tải 3,5 – 7,5 tấn",
  ...
  {
    id: "C", name: "Hạng C", short: "Tải trên 7,5 tấn",
  ...
  {
    id: "D1", name: "Hạng D1", short: "Khách 9 – 16 chỗ",
  ...
  {
    id: "D2", name: "Hạng D2", short: "Khách 17 – 29 chỗ",
  ...
  {
    id: "D", name: "Hạng D", short: "Khách trên 29 chỗ",
  ...
  {
    id: "BE", name: "Hạng BE", short: "B kéo rơ moóc > 750 kg",
  ...
  {
    id: "C1E", name: "Hạng C1E", short: "C1 kéo rơ moóc > 750 kg",
  ...
  {
    id: "CE", name: "Hạng CE", short: "Đầu kéo, sơ mi rơ moóc",
  ...
  {
    id: "D1E", name: "Hạng D1E", short: "D1 kéo rơ moóc > 750 kg",
  ...
  {
    id: "D2E", name: "Hạng D2E", short: "D2 kéo rơ moóc > 750 kg",
  ...
  {
    id: "DE", name: "Hạng DE", short: "D kéo rơ moóc, xe nối toa",
